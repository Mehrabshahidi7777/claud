...
class Activity extends Model
{
    ...
    public function label(): string
    {
        return match ($this->event) {
            ...
            'task.rescheduled' => 'مهلت تغییر کرد',
