    ...
    <form method="POST" action="{{ route('finance.import.store') }}" enctype="multipart/form-data"
        ...
        <div>
            ...
            <input id="file" name="file" type="file" accept=".csv,text/csv" required
                   class="mt-1 w-full rounded-xl border border-slate-300 px-3 py-2 text-sm file:me-3 file:rounded-lg file:border-0 file:bg-brand-700 file:px-3 file:py-1.5 file:text-white">
        ...
        <div class="flex flex-wrap items-center gap-3">
            <button type="submit"
                    class="rounded-xl bg-brand-700 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-800">
                درون‌ریزی
            </button>
