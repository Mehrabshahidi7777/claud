...
@php
    ...
    $icons = [
        ...
        'sponsors' => 'M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456Z',
            ...
            <a href="{{ route('sponsors.index') }}" @if ($current === 'sponsors.index') aria-current="page" @endif
               class="flex items-center gap-3 rounded-lg px-3 py-2 transition
                      {{ $current === 'sponsors.index'
                          ? 'bg-brand-50 font-medium text-brand-700'
                          : 'text-slate-600 hover:bg-slate-100 hover:text-slate-900' }}">
                <svg class="size-5 shrink-0 {{ $current === 'sponsors.index' ? 'text-brand-600' : 'text-amber-500' }}"
                     fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="{{ $icons['sponsors'] }}"/>
                </svg>
                اسپانسرهای پیگیر
            </a>
        </div>
